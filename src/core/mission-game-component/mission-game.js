...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const reflectionModal = new bootstrap.Modal(
...
document
  ...
  .addEventListener("click", function () {
    window.location.href =
      "../profession-puzzle-component/profession-puzzle.html";
  });
...
function updateReflectionSections() {
  const somewhatActionsSpan = document.getElementById(
    "somewhat-impactful-actions",
  );
  somewhatActionsSpan.textContent =
    selectedActions["Somewhat Impactful"].join(", ");

  const mostImpactfulActionsSpan = document.getElementById(
    "most-impactful-actions",
  );
  mostImpactfulActionsSpan.textContent =
    selectedActions["High Impact"].join(", ");

  const leastImpactfulActionsSpan = document.getElementById(
    "least-impactful-actions",
  );
  leastImpactfulActionsSpan.textContent =
    selectedActions["Low Impact"].join(", ");
}
